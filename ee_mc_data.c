 ...
 * Implementation stub to support event based implementation for OSEK standard rather than AUTOSAR.
 **/
...
//	rearm_budget_timer(expiration);/*Enable if using rti based budget monitor.*/
	rearm_watchdog_timer(expiration);
}
