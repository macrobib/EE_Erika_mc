...
extern const EE_oo_counter_object_ROM_type EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE];
#endif
#endif
...
#if defined (EE_COUNTER_OBJECTS_ROM_SIZE)
#if (EE_COUNTER_OBJECTS_ROM_SIZE > 0)
extern EE_oo_counter_object_RAM_type EE_oo_counter_object_RAM[EE_COUNTER_OBJECTS_ROM_SIZE];
#endif
#endif
...
typedef struct {
  ...
  /*Mode of operation of schedule table.*/
  ScheduleTableStatusType mode;
