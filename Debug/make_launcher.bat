...
@REM   i.e.   ${workspace_loc:sample}/make_launcher.bat

@REM   Unset CWD and PWD. They may cause cygwin warning.
@set CWD=
@set PWD=

@set EE_BASH_PATH=D:\repos\Apps\cygwin\bin\bash
...
@set ERIKA_FILES=C:\Users\CHANDRASHEKARAN\Documents\source_repo\litmus\sample\ee_files
